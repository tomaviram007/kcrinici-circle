...
CREATE TABLE public.event_registrations (
  ...
  -- Secret token returned to the registrant; required to confirm payment via edge function
...
-- Inserts/updates from the public flow go through the register-event edge function (service role).
